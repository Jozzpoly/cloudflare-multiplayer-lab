...
const ACTOR_RESUME_MAX_ATTEMPTS = 12;
...
function buildEvidence() {
  ...
  return {
    ...
    livePhysics: {
      ...
      actorPositions: localState?.sim?.actorBodies
        ? Object.fromEntries([...localState.sim.actorBodies.entries()].map(([sessionId, body]) => [sessionId, bodyPosition(body)]))
        : null,
